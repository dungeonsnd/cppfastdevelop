...
public:
    ...
    virtual cf_pvoid Initialize(cf_pvoid){ return NULL; }
    virtual cf_pvoid Finalize(cf_pvoid) { return NULL; }
};
...
{
public:
    ThreadPool(Runnable *task, size_t poolSize, size_t stacksize =threaddefs::DEFAULT_STACKSIZE, bool joinable = true);
    ~ThreadPool() {}
    cf_void Start();
    cf_void Join();
private:
