...
ssize_t cf_sendmsg(cf_int socket, cf_const struct msghdr *message, cf_int flags)
{
...
cf_int cf_bind(cf_int socket, cf_const struct sockaddr *address,socklen_t address_len)
{
    return bind(socket, address,address_len);

}

cf_int cf_connect(cf_int socket, cf_const struct sockaddr *address, socklen_t address_len)
{
    return   connect( socket, address, address_len);
}

cf_int cf_accept(cf_int socket, struct sockaddr * address, socklen_t * address_len)
{
...
cf_int cf_select(cf_int nfds, fd_set *readfds, fd_set *writefds, fd_set *exceptfds, struct timeval *timeout)
{
...
ssize_t cf_msgrcv(cf_int msqid, cf_pvoid buf, size_t length, cf_long type, cf_int flag)
{
...
cf_pvoid cf_mmap(cf_pvoid addr, size_t length, cf_int prot, cf_int flags, cf_int fd, off_t offset)
{
...
cf_int cf_pthread_attr_getstacksize(cf_const pthread_attr_t * attr, size_t * stacksize)
{
...
cf_int cf_pthread_attr_getdetachstate(cf_const pthread_attr_t *attr, cf_int *  detachstate)
{
...
cf_int cf_getpeername(cf_int socket, struct sockaddr * address, socklen_t * address_len)
{
