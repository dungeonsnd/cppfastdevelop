...
**/
bool SendSegmentSync(cf_int sockfd,cf_cpstr buf, ssize_t totalLen,ssize_t & hasDone,cf_int32 timeoutMilliSeconds,ssize_t segsize)
{
    if(totalLen == 0)
        return true;
    ssize_t len=0;
...
bool RecvSegmentSync(cf_int sockfd,cf_char * buf, ssize_t totalLen,ssize_t & hasDone,cf_int32 timeoutMilliSeconds,ssize_t segsize)
{
    if(totalLen == 0)
        return true;
    ssize_t len=0;
